    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
        {
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["LineItemsLockedNonDraft"] = "Line items cannot be edited because the invoice is no longer in Draft status.",
            ...
            ["mk"] = new Dictionary<string, string>
            {
                ...
                ["OutstandingBalances"] = "Незатворени Салда",
                ...
                ["NotesUpdated"] = "Забелешките се успешно зачувани",
                ["LineItemsLockedNonDraft"] = "Ставките не можат да се уредуваат бидејќи фактурата не е повеќе во статус Нацрт.",
