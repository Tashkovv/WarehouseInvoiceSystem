    ...
    public class LocalizationService : ILocalizationService
    {
        ...
        private readonly Dictionary<string, Dictionary<string, string>> _translations = new()
        {
            ...
            ["en"] = new Dictionary<string, string>
            {
                ...
                ["HelpAbout"] = "About",
                ["HelpAppVersion"] = "App Version",
                ["HelpSupportTitle"] = "Contact Support",
                ["HelpSupportBody"] = "If you encounter any issues or have questions about using the app, please reach out to your system administrator or support contact.",
                ["HelpSupportEmail"] = "Support Email",
                ["HelpSupportPhone"] = "Support Phone",
                ["HelpQuickGuide"] = "Quick Guide",
                ["HelpGuidePartners"] = "Partners — Manage companies and individuals you do business with.",
                ["HelpGuideDocuments"] = "Documents — Create and track invoices, purchase notes, and payments.",
                ["HelpGuideWarehouse"] = "Warehouse — Manage products, stock levels, and inventory movements.",
                ["HelpGuideDashboards"] = "Dashboards — Get financial and operational overviews at a glance.",
                // Privacy page
                ["PrivacyPageTitle"] = "Privacy Policy",
                ["PrivacyDataStorage"] = "Data Storage",
                ["PrivacyDataStorageBody"] = "All data entered into this application is stored locally in a database on your machine. No personal or business data is uploaded to external servers.",
                ["PrivacyEmail"] = "Email",
                ["PrivacyEmailBody"] = "When you send emails from the app, they are delivered via the SMTP server you configure in your Profile settings. Email content is transmitted directly through that server and is not processed or stored by this application.",
                ["PrivacyNoTracking"] = "No Tracking",
                ["PrivacyNoTrackingBody"] = "This application does not collect analytics, usage statistics, or telemetry data. Your usage of the app remains entirely private.",
            ...
            ["mk"] = new Dictionary<string, string>
            {
                ...
                ["Terms"] = "Услови",
                // Help page
                ["HelpPageTitle"] = "Помош и поддршка",
                ["HelpAbout"] = "За апликацијата",
                ["HelpAppVersion"] = "Верзија на апликацијата",
                ["HelpSupportTitle"] = "Контакт за поддршка",
                ["HelpSupportBody"] = "Доколку наидете на проблем или имате прашања за користење на апликацијата, обратете се до вашиот системски администратор или контакт за поддршка.",
                ["HelpSupportEmail"] = "Е-пошта за поддршка",
                ["HelpSupportPhone"] = "Телефон за поддршка",
                ["HelpQuickGuide"] = "Краток водич",
                ["HelpGuidePartners"] = "Партнери — Управувајте со компаниите и поединците со кои работите.",
                ["HelpGuideDocuments"] = "Документи — Креирајте и следете фактури, откупни белешки и плаќања.",
                ["HelpGuideWarehouse"] = "Магацин — Управувајте со производи, нивоа на залихи и движења на инвентар.",
                ["HelpGuideDashboards"] = "Контролни табли — Добијте финансиски и оперативни прегледи на едно место.",
                // Privacy page
                ["PrivacyPageTitle"] = "Политика за приватност",
                ["PrivacyDataStorage"] = "Складирање на податоци",
                ["PrivacyDataStorageBody"] = "Сите податоци внесени во оваа апликација се зачувуваат локално во база на податоци на вашата машина. Никакви лични или деловни податоци не се прикачуваат на надворешни сервери.",
                ["PrivacyEmail"] = "Е-пошта",
                ["PrivacyEmailBody"] = "Кога испраќате е-пошта преку апликацијата, таа се доставува преку SMTP серверот конфигуриран во вашите поставки за профил. Содржината на е-поштата се пренесува директно преку тој сервер и не се обработува или зачувува од оваа апликација.",
                ["PrivacyNoTracking"] = "Без следење",
                ["PrivacyNoTrackingBody"] = "Оваа апликација не собира аналитички, статистички или телеметриски податоци. Вашето користење на апликацијата останува целосно приватно.",
